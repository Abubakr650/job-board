            ...
            <form action="{{ $formAction }}" method="POST">
               ...
               <div class="mb-4 p-6 bg-gray-50 border border-gray-100 rounded-lg shadow-sm">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="owner_name" name="owner_name" value="{{ old('owner_name', $company->owner->name) }}" required
                    ...
                    <div class="mb-4">
                        ...
                        <input readonly type="email" id="owner_email" name="owner_email"  value="{{ old('owner_email', $company->owner->email) }}" required
                            class="{{ $errors->has('owner_email') ? 'outline-red-500 outline outline-1' : '' }} shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline bg-gray-100">
                        <x-input-error :messages="$errors->get('owner_email')" class="mt-2" />            
                    </div>

                      <!-- Owner Password (Can update the password) -->
                    <div class="mt-4">
                        <label for="owner_password" class="block text-gray-700 font-bold mb-2">Change Owner Password (Leave blank to keep the same)</label>
