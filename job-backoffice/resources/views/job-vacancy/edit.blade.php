                ...
                <div class="mb-4 p-6 bg-gray-50 border border-gray-100 rounded-lg shadow-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="mb-4">
                            ...
                            <input type="text" id="title" name="title" value="{{ old('title', $jobVacancy->title) }}" required autofocus
                    ...
                    <div class="mb-4 py-6">
                        ...
                        <textarea id="description" name="description" rows="5" required 
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ old('description', $jobVacancy->description) }}</textarea>
